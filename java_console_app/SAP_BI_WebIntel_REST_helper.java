...
public class SAP_BI_WebIntel_REST_helper {
	...
	public void TEST_SAVE_ALL_DOCUMENTS(String output_file_name) {
		try {
			HashMap<String, ArrayList<DocumentInfo>> map = Save_All_Documents();
			if (map != null) {
				int ff=0;
				FileWriter myfile = new FileWriter(output_file_name);
			...
			System.out.println("EXCEPTION CAUGHT in class SAP_BI_WebIntel_REST_helper method TEST_SAVE_ALL_DOCUMENTS !!!!!");
			ex.printStackTrace();
		}
	}
	...
	public void Demo2() throws Exception {
		...
		myresponse = rest.sendGet_token(PROTOCOL_HOST_PORT + "biprws/infostore/Root%20Folder/children?page=1", TOKEN);
		if (myresponse.responseCode == 200)
		{
			System.out.println(myresponse.response);
		}
