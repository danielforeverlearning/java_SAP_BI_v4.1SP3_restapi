...
public class RestAPICaller {
	...
	// HTTP GET request
	public int sendGet_token_with_quotes_file_output(String url, String acceptstr, String filename, String TOKEN_WITH_QUOTES) throws Exception {
	...
	// HTTP GET request
	public RestAPIResponse sendGet_token_with_quotes(String url, String TOKEN_WITH_QUOTES) throws Exception {
	...
	// HTTP GET request
	public RestAPIResponse sendGet_token(String url, String TOKEN) throws Exception {
