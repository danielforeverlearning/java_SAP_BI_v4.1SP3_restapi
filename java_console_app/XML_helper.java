...
public class XML_helper {
	...
	//map is modified
	//
	//(see method "XML_FILE_TEST_get_documents" below 
	// which tests "get_documents" without the internet using an XML file
	// that was saved previously from response string from restful-API call)
	//****************************************************************************
	...
	public void XML_FILE_TEST_get_documents() {
		...
		xmlhelp.parse_xml_file("documents_size50_offset0_xml_response.xml");
